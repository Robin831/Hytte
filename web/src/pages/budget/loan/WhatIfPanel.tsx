...
import { EMPTY_WHAT_IF } from './types'
 ...
 */
export function WhatIfPanel({ loanId, params, onChange, summary, error, pending, t }: {
  loanId: number
  params: WhatIfParams
  ...
  return (
    <div className="mb-4">
      ...
      >
        ...
        {t('loan.whatIf.title')}
        {hasInput && <span className="w-1.5 h-1.5 rounded-full bg-blue-400" />}
      </button>
