...
export default function ForgeSettingsPage() {
  ...
  const anvilNames = Object.keys(config.anvils).sort()
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-3">
          <NavLink to="/forge" className="text-gray-400 hover:text-white transition-colors">
            <ArrowLeft size={20} />
          </NavLink>
      ...
      {/* Global Settings */}
      <CollapsibleSection id="forge-settings" title={t('sections.settings')} defaultExpanded>
        <div className="space-y-4">
          <h3 className="text-sm font-medium text-gray-400 uppercase tracking-wider">{t('settings.concurrency')}</h3>
          ...
          <h3 className="text-sm font-medium text-gray-400 uppercase tracking-wider mt-6">{t('settings.timing')}</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <TextField
          ...
          <h3 className="text-sm font-medium text-gray-400 uppercase tracking-wider mt-6">{t('settings.retryLimits')}</h3>
          ...
          <h3 className="text-sm font-medium text-gray-400 uppercase tracking-wider mt-6">{t('settings.features')}</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <ToggleField
          ...
          <h3 className="text-sm font-medium text-gray-400 uppercase tracking-wider mt-6">{t('settings.providers')}</h3>
          <ListField
      ...
      {/* Anvils */}
      <CollapsibleSection id="forge-anvils" title={t('sections.anvils')} defaultExpanded={false}>
      ...
      {/* Notifications */}
      <CollapsibleSection id="forge-notifications" title={t('sections.notifications')} defaultExpanded={false}>
        <div className="space-y-4">
          <ToggleField
      ...
      <div className="fixed bottom-6 right-6 md:hidden">
        <button
          onClick={saveConfig}
          disabled={saving}
          className="flex items-center gap-2 px-5 py-3 bg-blue-600 hover:bg-blue-700 disabled:opacity-50 rounded-full text-sm font-medium shadow-lg transition-colors cursor-pointer"
        >
          <Save size={16} />
          {saving ? t('saving') : t('save')}
        </button>
