...
export default function GuestTodayView() {
  ...
  return (
    <>
      ...
      <div className="bg-gray-800 rounded-xl p-4 col-span-2" role="region" aria-label={t('guest.signIn')}>
        <div className="flex flex-col items-center gap-3 py-4">
          <LogIn size={24} className="text-gray-400" aria-hidden="true" />
          <p id="login-prompt" className="text-sm text-gray-400 text-center">{t('guest.loginPrompt')}</p>
          <a
