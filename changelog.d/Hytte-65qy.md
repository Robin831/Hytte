category: Added
- **Norwegian progressive tax brackets** - Tax bracket table with proper marginal rate calculation. Norwegian 2025/2026 defaults are seeded automatically; brackets are updatable per-year via GET/PUT `/api/salary/tax-table?year=`. (Hytte-65qy)
