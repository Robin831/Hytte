...
- **Challenge participants API** - Added `GET /api/family/challenges/{id}/participants` endpoint returning enrolled children with their completion status, used by the parent challenges page. (Hytte-g9re)
