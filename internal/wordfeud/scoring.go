...
// verified live against the Wordfeud API: POST /tile_points/1/
// (language_code: nb) on 2026-08-05. Q, X, Z are NOT in the Norwegian tile
// bag (0 tiles); the API reports them as 0 points — they can only ever enter
// play via a blank, which scores 0 regardless.
var LetterValue = map[rune]int{
	'A': 1, 'B': 4, 'C': 10, 'D': 1, 'E': 1,
	'F': 2, 'G': 4, 'H': 3, 'I': 2, 'J': 4,
	'K': 3, 'L': 2, 'M': 2, 'N': 1, 'O': 3,
	'P': 4, 'Q': 0, 'R': 1, 'S': 1, 'T': 1,
	'U': 4, 'V': 5, 'W': 10, 'X': 0, 'Y': 8,
	'Z': 0, 'Æ': 8, 'Ø': 4, 'Å': 4,
}
